  ...
  return (
    ...
    <div className="carousel w-full flex flex-col py-10">
      ...
      <div className="flex justify-center items-center space-x-4">
        ...
        <div className="grid grid-cols-2 w-[95%]  gap-4 md:grid-cols-3">
          {images.slice(currentIndex, currentIndex + 3).map((image, index) => (
            <div key={index} className="relative text-center">
              <img src={image.src} alt={image.text} className="w-full" />
              <div className="absolute bottom-10 md:w-[30%] sm:w-[20%] items-center left-0 right-0 bg-gray-300 bg-opacity-50 text-black py-2">
